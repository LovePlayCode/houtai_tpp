...
//        gc.setOutputDir("D:\\gui_parent\\service\\service-edu" + "/src/main/java");
        gc.setOutputDir("/Users/lhl/IdeaProjects/tppparent/service/comTabService/src/main/java");
        gc.setAuthor("lhl");
        ...
        pc.setModuleName("comTabSer"); //模块名
        ...
        // 设置表名
        strategy.setInclude("movie_commenttype","comment");
